...
/////////////////
const BotName = 'WilBot2.0'; 
const instagram = 'https://instagram.com/wildan.mc'; 
const telegram = 'ga punya om v:'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCbRSVFAHFqy3_8efoUazJZw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@wildan.mc')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@wildan.mc`)
})
